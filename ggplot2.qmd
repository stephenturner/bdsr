...
**This lesson assumes a basic familiarity with R ([Chapter -@sec-basics]), data frames ([Chapter -@sec-tibbles]), and manipulating data with dplyr and `|>` ([Chapter -@sec-dplyr]).**
