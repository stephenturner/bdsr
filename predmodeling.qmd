...
# Predictive Analytics: Predicting and Forecasting Influenza {#sec-predmodeling}
...
**Handout**: [Predictive Modeling Handout](handouts/r-predictive-modeling.pdf).
...
There are two datasets available in [data.zip](data/data.zip): 
...
Let's use ggplot2 to take a look at the data. Refer back to the visualization section ([Chapter -@sec-ggplot2]) if you need a refresher.
...
# This chunk is here if you just want to start interactive development
